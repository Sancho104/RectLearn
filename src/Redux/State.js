...
let state = {
    dialogsPage : {
        dialogsData : [
            { id: 1, name: 'Vasiliy', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxMjA3fDB8MXxzZWFyY2h8MXx8cGVyc29ufHwwfHx8&ixlib=rb-1.2.1&q=80&w=1080' },
            { id: 2, name: 'Hryn`', photo: 'https://ak.picdn.net/shutterstock/videos/7076620/thumb/1.jpg' },
            { id: 3, name: 'Sulimka', photo: 'https://ak.picdn.net/shutterstock/videos/7076620/thumb/1.jpg' },
            { id: 4, name: 'Anatolivna', photo: 'https://ak.picdn.net/shutterstock/videos/7076620/thumb/1.jpg' }
        ],
        messageData : [
